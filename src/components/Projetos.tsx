                ...
                <ul className="grid md:grid-cols-2 2xl:grid-cols-3 gap-5">
                    <li className="bg-gray-900 w-96 xl:w-[415px] h-96 rounded-xl hover:shadow-lg hover:shadow-blue-600">
                        ...
                        <div className="flex justify-between mx-5 my-5">
                            ...
                            <div className="flex items-center">
                                <a className="hover:-translate-y-2 hover:shadow-lg hover:shadow-white" href="https://github.com/abneeralves/SitePorsche" target="_blank"><Image className="invert" src={GitHub} alt="Icone Github" width={20}/></a>
                            </div>
                        </div>
                    </li>
                    ...
                    <li className="bg-gray-900 w-96 xl:w-[415px] h-96 rounded-xl hover:shadow-lg hover:shadow-blue-600">
                        ...
                        <div className="flex justify-between mx-5 my-5">
                            ...
                            <div className="flex items-center">
                                <a className="hover:-translate-y-2 hover:shadow-lg hover:shadow-white" href="https://github.com/abneeralves/Site-Mario" target="_blank"><Image className="invert" src={GitHub} alt="Icone Github" width={20}/></a>
                            </div>
                        </div>
                    ...
                    <li className="bg-gray-900 w-96 xl:w-[415px] h-96 rounded-xl hover:shadow-lg hover:shadow-blue-600">
                        ...
                        <div className="flex justify-between mx-5 my-5">
                            ...
                            <div className="flex items-center">
                                <a className="hover:-translate-y-2 hover:shadow-lg hover:shadow-white" href="https://github.com/abneeralves/CloneNetflix" target="_blank"><Image className="invert" src={GitHub} alt="Icone GitHub" width={20}/></a>
                            </div>
                        </div>
                    ...
                    <li className="bg-gray-900 w-96 xl:w-[415px] h-96 rounded-xl hover:shadow-lg hover:shadow-blue-600">
                        ...
                        <div className="flex justify-between mx-5 my-5">
                            ...
                            <div className="flex items-center">
                                <a className="hover:-translate-y-2 hover:shadow-lg hover:shadow-white" href="https://github.com/abneeralves/CalculadoraIMC" target="_blank"><Image className="invert" src={GitHub} alt="Icone GitHub" width={20}/></a>
                            </div>
                        </div>
                    ...
                    <li className="bg-gray-900 w-96 xl:w-[415px] h-96 rounded-xl hover:shadow-lg hover:shadow-blue-600">
                        ...
                        <div className="flex justify-between mx-5 my-5 xl:my-11">
                            ...
                            <div className="flex items-center">
                                <a className="hover:-translate-y-2 hover:shadow-lg hover:shadow-white" href="https://github.com/abneeralves/BuscadorCep" target="_blank"><Image className="invert" src={GitHub} alt="Icone GitHub" width={20}/></a>
                            </div>
                        </div>
                    </li>
                    ...
                    <li className="bg-gray-900 w-96 xl:w-[415px] h-96 rounded-xl mb-32 hover:shadow-lg hover:shadow-blue-600">
                        ...
                        <div className="flex justify-between mx-5 my-5">
                            ...
                            <div className="flex items-center">
                                <a className="hover:-translate-y-2 hover:shadow-lg hover:shadow-white" href="https://github.com/abneeralves/Calculadora" target="_blank"><Image className="invert" src={GitHub} alt="Icone GitHub" width={20}/></a>
                            </div>
                        </div>
                    </li>
                </ul>
