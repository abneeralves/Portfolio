...
export default function Skills() {
    return (
        <section id='skills' className={`relative flex flex-col items-center bg-[#171330] overflow-hidden  relative overflow-hidden h-full before:absolute before:inset-0 before:bg-[linear-gradient(rgba(23,19,48,0.03)_1px,transparent_1px),linear-gradient(90deg,rgba(23,19,48,0.03)_1px,transparent_1px)] before:bg-[size:50px_50px] before:pointer-events-none ${Mono.className}`}>
