...
export default function Main() {
    return (
        <main id="sobre" className="relative flex flex-col justify-center pl-20 bg-[#171330] h-full py-20 overflow-hidden">

            <div className='flex justify-end absolute w-full h-full z-0 right-10 top-20'>
                <svg width="100" height="100">
                    <rect x="10" y="10" width="100" height="100" stroke="black" stroke-width="3" fill="white" />
                </svg>
            ...
            <div className='relative z-10 xl:grid grid-cols-2 2xl:grid-cols-2 2xl:gap-4 my-10' data-aos="fade-up">
                <div className='col-span-1'>
                    <div className="relative" data-aos="fade-right">
                        <div className="flex items-center mt-20">
                            <div className="z-20 absolute">
                                <h1 className={`sm:text-8xl text-4xl text-[#ffd401] mt-16 ${BebasN.className}`}>Sobre Mim.</h1>
                            </div>
                            ...
                            <div className="z-10 absolute flex items-center">
                                ...
                                <h2 className={`sm:text-[10rem] text-6xl text-blue-900 ${BebasN.className}`}>About</h2>
                            </div>
                        </div>
                    </div>

                    <div className='mt-24' data-aos="fade-up">
                        <p className={`text-white text-md lg:text-2xl xl:mt-5 p-5 pb-0 xl:pl-0 2xl:mt-5 ${Exo.className}`}>
                    ...
                    <div className='flex flex-col m-5 xl:ml-0 2xl:ml-0 xl:mr-8 2xl:mt-10' data-aos="fade-up">
                        <p className={`text-zinc-500 text-lg mb-2 ${Exo.className}`}>OBS: Você pode encontrar este projeto no <span className='text-[#ffd401] underline decoration-1'><a href="https://github.com/abneeralves/Portfolio" target="_blank" rel="noopener noreferrer">GitHub.</a></span></p>
