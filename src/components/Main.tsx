...
export default function Main () {
    return (
        <main className="flex flex-col items-center justify-center bg-blue-600 h-full">
            ...
            <div className='md:grid grid-cols-2 2xl:grid-cols-2 2xl:gap-4 bg-gray-900 lg:h-6/6 w-5/6 2xl:h-4/6 rounded-2xl hover:shadow-md hover:shadow-gray-300'>
